 ...
 */
public class NoiseGenerator { //Literally just Kevin Perlin's Improved Noise

//    public static double noise(double x, double y, double z){
//        int xi = (int)x & 255;  //Should I be flooring these?
//        int yi = (int)y & 255;
//        int zi = (int)z & 255;
//
//        double u = fade(xf); //w
...
//
//
//    private static final int p[] = new int[512], permutation[] = { //Kevin Perlin's Box of Magic Numbers
...
//            204,176,115,121,50,45,127,4,150,254,138,236,205,93,222,114,67,29,24,72,243,141,128,
